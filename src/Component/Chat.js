                ...
                {isUpDown ?
                    <div className="container-fluid p-0" >
                        ...
                        <div className="chat-width-1 view m-0 overlay rgba-green-light btn py-0 px-3" >
                            ...
                            <div style={{ textShadow: "1px 1px 1px #222" }} className="float-left pt-2"><strong> Chat - Tooba Anwer </strong> </div>
                    ...
                    <div className="container-fluid p-0" >
                        ...
                        <div className="chat-width-1 view m-0 overlay rgba-green-light btn py-0 px-3" >
                            <div className="pr-1 float-left pt-2"><IoChatbubbleWorking style={{ fontSize: 20 }} className="text-info" /> </div>
                            <div style={{ textShadow: "1px 1px 1px #ddd" }} className="float-left pt-2"><strong> Chat - Tooba Anwer </strong></div>
                            <div className="float-right" >
