                                ...
                                <div>
                                    ...
                                    <div className="text-center" >
                                        <h5 className="font-weight-bold h5 d-block">
                                            <strong>Tooba Anwer</strong>
                                        </h5>
                                        <p className="grey-text">Developer</p>
                                    </div>
                                    <p>Hey, I’m Tooba. I’m a web and mobile applications developer from the Pakistan.

                                    I’ve been building websites and mobile applications for over 1 year and currently live in a place called Pakistan with my family, Adele and our cat, Shadow.
