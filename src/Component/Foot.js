...
class Foot extends Component {
    ...
    render() {
        return (
            <div className="text-center " style={{ background: 'black', color: '#fff' }} >
                {/* popup */}
                ...
                <div className="py-3" >
                    <h1 > Tooba Anwer </h1>
                    <small style={{ color: "#ddd" }} className="" >&copy; 2020 Full Stack Developer All Right Reserved. </small>
                </div>
                ...
                <div className="row pb-5" >
                    <div className="col-sm-12 col-md-12 col-lg-6 text-left" >
                        <p className="px-5 font" >Tooba Anwer is Full Stack Developer that promotes technology advocacy, inclusivity and adaptation within the industries of Pakistan; as we know technology… <span style={{ color: "#00d2f3", cursor: "pointer" }} >Read more </span> </p>
                    </div>

                    <div className="col-sm-12 col-md-12 col-lg-6 pt-5"  >
                        <IoSocialFacebook onClick={() => window.open("https://www.facebook.com/ToobayyyAnwer/", "_blank")} className="footIcon facebook " />
                        {/* <IoSocialLinkedin onClick={() => window.open("https://www.linkedin.com/in/ameen-alam-375390134/", "_blank")} className="footIcon linkedin" /> */}
                        <a style={{ textDecoration: "none" }} href="mailto:toobaanwer32@@gmail.com"><IoIosEmail className="footIcon email" /></a>
                        <IoSocialGithub onClick={() => window.open("https://github.com/Tooba-star", "_blank")} className="footIcon github" />
                        ...
                        <IoSocialInstagram onClick={() => window.open("https://www.instagram.com/syeda_tooba_anwer/", "_blank")} className="footIcon instagram" />
